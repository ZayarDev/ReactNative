...
class App extends Component {
  ...
  render() {
    ...
    return (
      <View style={{flex: 1}}>
        <SafeAreaView style={{flex: 0, backgroundColor: '#5BCFF7'}} />
            ...
            <ScrollView
              ...
              <View style={style.upperView}>
                <View style={style.subUpperView}>
                  <View
                    style={{flex: 0.1, justifyContent: 'center', marginTop: 7}}>
                    <Text
                      style={{
                        alignSelf: 'center',
                        fontSize: 14,
                  ...
                  <View
                    style={{flex: 0.1, justifyContent: 'center', marginTop: 5}}>
                    <Text
                      style={{
                        alignSelf: 'center',
                        fontSize: 50,
